...
public class DirectReader {
  ...
  public static LongValues getMergeInstance(
    ...
    return new LongValues() {
      ...
      private final long tail = numValues - MERGE_BUFFER_SIZE;
      ...
      private void fillBuffer(long index) throws IOException {
        ...
        if (index >= tail) {
          ...
          long offset = baseOffset + ((index * bitsPerValue) >>> 3);
          UnrollingDecoder.decode(slice, offset, buffer, bitsPerValue);
        }
      }
    };
  }
